package cl.tofcompany.sift.Service;
...
import cl.tofcompany.sift.Channel.NotificationHelper;
import cl.tofcompany.sift.Controllers.Drivers.NotificationBooking;
import cl.tofcompany.sift.R;
import cl.tofcompany.sift.receivers.AcceptReceiver;
import cl.tofcompany.sift.receivers.CancelReceiver;
...
//metodo para la notification
    private void showNotificationActivity(String idClient, String origin, String destination, String min, String distance) {
        ...
        //preguntamos sin la pantalla esta encendida o no en caso contrario lo encendemos con la notificacion
        if (!isScreenOn){
        ...
        //pasar los datos que llega en la notificacion en nuesta pantalla de notificacion y recibirlo en notificationbookin.class
    ...
    private void showNotificationApiOreo(String title, String body) {
        ...
        NotificationHelper notificationHelper = new NotificationHelper(getBaseContext());
        Notification.Builder builder = notificationHelper.getNotification(title,body,pendingIntent,uri);
        notificationHelper.getManager().notify(1, builder.build());
    }
